...
async def generate_video(text: str, slider_value: int, url: str = "http://192.168.50.48:58501/", headless: bool = False):
    """
    执行视频生成流程
...
async def main():
    ...
    parser.add_argument("-s", "--slider", type=int, default=5, choices=range(5, 31),
                       help="滑块值 (5-30), 默认: 5")
    parser.add_argument("-u", "--url", default="http://192.168.50.48:58501/",
                       help="目标URL")
