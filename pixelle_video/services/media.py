    ...
    async def __call__(
        ...
        **params
        ...
        try:
            ...
            # Determine service name based on media type
            service_name = "video" if media_type == "video" else "image"
            kit = await self.core._get_or_create_comfykit(service_name=service_name)
